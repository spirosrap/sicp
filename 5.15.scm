  ...
  (let ((pc (make-register 'pc))
    ...
    (let ((the-ops
           (list (list 'initialize-stack
	             ...
	             (list 'print-instruction-counter
	                         (lambda () (display (list 'No-instructions '= inst-count))))
...
;maybe it is not so good to have an extra instruction in the machine counting the instructions. So I installed it to the machines model:
